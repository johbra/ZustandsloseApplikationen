...
var G__4835 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
ch = G__4835;
continue;
}
break;
...
return cljs.tools.reader.read_tagged.call(null,(function (){var G__4836 = rdr;
cljs.tools.reader.reader_types.unread.call(null,G__4836,ch);
...
if(("\\" === ch__$1)){
var ch_4837__$2 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
if((ch_4837__$2 == null)){
cljs.tools.reader.impl.errors.throw_eof_reading.call(null,rdr,new cljs.core.Keyword(null,"regex","regex",939488856),sb);
} else {
}

sb.append(ch_4837__$2);
} else {
}

var G__4838 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
ch__$1 = G__4838;
continue;
}
}
...
var vec__4846 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__4846,(0),null);
var start_column = cljs.core.nth.call(null,vec__4846,(1),null);
...
var G__4849 = cljs.core.conj_BANG_.call(null,a,form);
a = G__4849;
continue;
}
}
...
var _STAR_read_delim_STAR_4850 = cljs.tools.reader._STAR_read_delim_STAR_;
...
}finally {cljs.tools.reader._STAR_read_delim_STAR_ = _STAR_read_delim_STAR_4850;
}});
/**
 * Read in a list, including its location if the reader is an indexing reader
 */
cljs.tools.reader.read_list = (function cljs$tools$reader$read_list(rdr,_,opts,pending_forms){
var vec__4851 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__4851,(0),null);
var start_column = cljs.core.nth.call(null,vec__4851,(1),null);
...
var vec__4854 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__4854,(0),null);
var end_column = cljs.core.nth.call(null,vec__4854,(1),null);
...
var vec__4857 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__4857,(0),null);
var start_column = cljs.core.nth.call(null,vec__4857,(1),null);
...
var vec__4860 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__4860,(0),null);
var end_column = cljs.core.nth.call(null,vec__4860,(1),null);
...
var vec__4863 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__4863,(0),null);
var start_column = cljs.core.nth.call(null,vec__4863,(1),null);
...
var vec__4866 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__4866,(0),null);
var end_column = cljs.core.nth.call(null,vec__4866,(1),null);
...
var sb = (function (){var G__4869 = (new goog.string.StringBuffer());
G__4869.append(initch);
...
var G__4871 = (function (){var G__4870 = sb;
G__4870.append(ch);

return G__4870;
})();
var G__4872 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
sb = G__4871;
ch = G__4872;
continue;
}
...
switch (G__4875) {
case "\\":
var G__4879 = (function (){var G__4876 = sb;
G__4876.append(cljs.tools.reader.escape_char.call(null,sb,reader));

return G__4876;
})();
var G__4880 = cljs.tools.reader.reader_types.read_char.call(null,reader);
sb = G__4879;
ch = G__4880;
continue;
...
break;
default:
var G__4881 = (function (){var G__4877 = sb;
G__4877.append(ch);

return G__4877;
})();
var G__4882 = cljs.tools.reader.reader_types.read_char.call(null,reader);
sb = G__4881;
ch = G__4882;
continue;
...
var vec__4883 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__4883,(0),null);
var end_column = cljs.core.nth.call(null,vec__4883,(1),null);
...
var vec__4886 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var line = cljs.core.nth.call(null,vec__4886,(0),null);
var column = cljs.core.nth.call(null,vec__4886,(1),null);
...
var vec__4891 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var line = cljs.core.nth.call(null,vec__4891,(0),null);
var column = cljs.core.nth.call(null,vec__4891,(1),null);
...
var vec__4896 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var line = cljs.core.nth.call(null,vec__4896,(0),null);
var column = cljs.core.nth.call(null,vec__4896,(1),null);
var m = cljs.tools.reader.impl.utils.desugar_meta.call(null,cljs.tools.reader.read_STAR_.call(null,rdr,true,null,opts,pending_forms));
if(cljs.core.map_QMARK_.call(null,m)){
} else {
cljs.tools.reader.impl.errors.throw_bad_metadata.call(null,rdr,m);
...
var vec__4901 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__4901,(0),null);
var start_column = cljs.core.nth.call(null,vec__4901,(1),null);
...
var vec__4904 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__4904,(0),null);
var end_column = cljs.core.nth.call(null,vec__4904,(1),null);
...
var G__4907 = rdr;
cljs.tools.reader.read_STAR_.call(null,G__4907,true,null,opts,pending_forms);
...
var G__4908 = sym;
if(cljs.core._EQ_.call(null,new cljs.core.Symbol(null,"NaN","NaN",666918153,null),G__4908)){
return Number.NaN;
} else {
if(cljs.core._EQ_.call(null,new cljs.core.Symbol(null,"-Inf","-Inf",-2123243689,null),G__4908)){
return Number.NEGATIVE_INFINITY;
} else {
if(cljs.core._EQ_.call(null,new cljs.core.Symbol(null,"Inf","Inf",647172781,null),G__4908)){
...
var _STAR_suppress_read_STAR_4909 = cljs.tools.reader._STAR_suppress_read_STAR_;
...
}finally {cljs.tools.reader._STAR_suppress_read_STAR_ = _STAR_suppress_read_STAR_4909;
}});
...
var G__4910 = cljs.tools.reader.read_STAR_.call(null,rdr,false,cljs.tools.reader.READ_EOF,")",opts,pending_forms);
cljs.tools.reader.check_eof_error.call(null,G__4910,rdr,first_line);

cljs.tools.reader.check_invalid_read_cond.call(null,G__4910,rdr,first_line);
...
var G__4914 = matched;
var G__4915 = cljs.tools.reader.read_suppress.call(null,first_line,rdr,opts,pending_forms);
matched = G__4914;
finished = G__4915;
continue;
} else {
...
var _STAR_suppress_read_STAR_4916 = cljs.tools.reader._STAR_suppress_read_STAR_;
...
}finally {cljs.tools.reader._STAR_suppress_read_STAR_ = _STAR_suppress_read_STAR_4916;
}}
} else {
return cljs.tools.reader.impl.errors.throw_eof_in_character.call(null,rdr);
}
...
var arg_env4917 = cljs.tools.reader.arg_env;
cljs.tools.reader.arg_env = cljs.core.sorted_map.call(null);

try{var form = cljs.tools.reader.read_STAR_.call(null,(function (){var G__4918 = rdr;
cljs.tools.reader.reader_types.unread.call(null,G__4918,"(");
...
var G__4919 = (i + (1));
var G__4920 = cljs.core.conj_BANG_.call(null,args,(function (){var or__3922__auto__ = cljs.core.get.call(null,cljs.tools.reader.arg_env,i);
if(cljs.core.truth_(or__3922__auto__)){
return or__3922__auto__;
} else {
...
}finally {cljs.tools.reader.arg_env = arg_env4917;
}});
/**
...
var ch = temp__4655__auto__;
if(cljs.core._EQ_.call(null,"@",ch)){
return cljs.tools.reader.wrapping_reader.call(null,new cljs.core.Symbol("clojure.core","unquote-splicing","clojure.core/unquote-splicing",-552003150,null)).call(null,(function (){var G__4921 = rdr;
cljs.tools.reader.reader_types.read_char.call(null,G__4921);
...
var G__4922 = cljs.core.next.call(null,s__$1);
var G__4923 = ret;
s__$1 = G__4922;
r = G__4923;
continue;
...
var G__4924 = cljs.core.next.call(null,s);
var G__4925 = cljs.core.conj_BANG_.call(null,cljs.core.conj_BANG_.call(null,key_vals,cljs.core.key.call(null,e)),cljs.core.val.call(null,e));
s = G__4924;
key_vals = G__4925;
continue;
} else {
...
var gensym_env4929 = cljs.tools.reader.gensym_env;
...
}finally {cljs.tools.reader.gensym_env = gensym_env4929;
}});
...
var temp__4655__auto__ = ((cljs.core._EQ_.call(null,token,":"))?cljs.core.ns_name.call(null,cljs.core._STAR_ns_STAR_):((cljs.core._EQ_.call(null,":",cljs.core.first.call(null,token)))?(function (){var G__4930 = token;
var G__4930__$1 = (((G__4930 == null))?null:cljs.core.subs.call(null,G__4930,(1)));
var G__4930__$2 = (((G__4930__$1 == null))?null:cljs.tools.reader.impl.commons.parse_symbol.call(null,G__4930__$1));
var G__4930__$3 = (((G__4930__$2 == null))?null:cljs.tools.reader.impl.utils.second_SINGLEQUOTE_.call(null,G__4930__$2));
var G__4930__$4 = (((G__4930__$3 == null))?null:cljs.core.symbol.call(null,G__4930__$3));
if((G__4930__$4 == null)){
return null;
} else {
return cljs.tools.reader.resolve_ns.call(null,G__4930__$4);
}
})():(function (){var G__4931 = token;
var G__4931__$1 = (((G__4931 == null))?null:cljs.tools.reader.impl.commons.parse_symbol.call(null,G__4931));
if((G__4931__$1 == null)){
return null;
} else {
return cljs.tools.reader.impl.utils.second_SINGLEQUOTE_.call(null,G__4931__$1);
}
})()
));
if(cljs.core.truth_(temp__4655__auto__)){
...
}catch (e4938){if((e4938 instanceof Error)){
var e = e4938;
...
cljs.tools.reader.read.cljs$core$IFn$_invoke$arity$2 = (function (p__4942,reader){
var map__4943 = p__4942;
var map__4943__$1 = ((((!((map__4943 == null)))?(((((map__4943.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__4943.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__4943):map__4943);
var opts = map__4943__$1;
var eof = cljs.core.get.call(null,map__4943__$1,new cljs.core.Keyword(null,"eof","eof",-489063237),new cljs.core.Keyword(null,"eofthrow","eofthrow",-334166531));
...
var len__4499__auto___4951 = arguments.length;
var i__4500__auto___4952 = (0);
while(true){
if((i__4500__auto___4952 < len__4499__auto___4951)){
args__4502__auto__.push((arguments[i__4500__auto___4952]));

var G__4953 = (i__4500__auto___4952 + (1));
i__4500__auto___4952 = G__4953;
continue;
} else {
}
break;
...
/** @this {Function} */
cljs.tools.reader.read_PLUS_string.cljs$lang$applyTo = (function (seq4949){
var G__4950 = cljs.core.first.call(null,seq4949);
var seq4949__$1 = cljs.core.next.call(null,seq4949);
var self__4486__auto__ = this;
return self__4486__auto__.cljs$core$IFn$_invoke$arity$variadic(G__4950,seq4949__$1);
});
